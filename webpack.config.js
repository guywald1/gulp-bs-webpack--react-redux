...
var webpackSettings = {
	entry: {
		app: [
			...
			path.join(process.cwd(), config.src.js, 'index')
		]
	},
	output: {
	...
	plugins: environments.production()
		...
		: [
			new webpack.optimize.OccurenceOrderPlugin(), new webpack.NoErrorsPlugin(), new webpack.HotModuleReplacementPlugin()
		],
	resolve: {
		extensions: ['', '.js', '.jsx']
	},
		...
		loaders: [
			{
				...
				loaders: ['babel?presets[]=react,presets[]=es2015,presets[]=stage-2', 'webpack-module-hot-accept']
			}
		]
	}
};
